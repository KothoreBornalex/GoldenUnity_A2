...
public class PatrolEnnemy : GuardGlobalClass
{
    ...
    private void RotateEnnemy()
    {
        ...
        {
            transform.rotation = new Quaternion(0, 0, 0, 1);  //new Quaternion(0, 0, 0.7071f, 0.7071f);

        }
        else if ( _directionY == -1f && _directionX == 0f)
        {
            transform.rotation = new Quaternion(0, 0, 1, 0); //new Quaternion(0, 0, -0.7071f, 0.7071f);
        }
    }
}
